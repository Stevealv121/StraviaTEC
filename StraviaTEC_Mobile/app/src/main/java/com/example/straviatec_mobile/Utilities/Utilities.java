...
public class Utilities {
    ...
    public static final String CREATE_USER_TABLE = "CREATE TABLE "+TABLE_USER+" ("+FIELD_USERNAME+" TEXT, "+FIELD_FNAME+" TEXT, "+FIELD_SNAME+" TEXT, "+FIELD_FSNAME+" TEXT, "+FIELD_SSNAME+" TEXT, "+FIELD_LEVEL+" TEXT, "+FIELD_PROFILEPIC+" BLOB, "+FIELD_BDATE+" TEXT, "+FIELD_PASS+" TEXT)";
